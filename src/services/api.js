...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL || 'https://wattanun-backend-fbe9gng2djbadehc.southeastasia-01.azurewebsites.net/api',
...
const FUNCTION_API_URL = 'https://wattanun-filter-app-bvezd2exbxfafwew.southeastasia-01.azurewebsites.net/api'; // Example: 'https://<YOUR_FUNCTION_APP_NAME>.azurewebsites.net/api'
